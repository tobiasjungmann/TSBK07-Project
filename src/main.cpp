...
void init(void)
{
	...
	auto fish2 = std::make_unique<obj::Fish>(green_reef, vec3(15, 4, 10), normalize(vec3(5, 1, 0)));
	auto fish3 = std::make_unique<obj::Fish>(green_reef, vec3(10,4,15), normalize(vec3(1, 1, 0)));
